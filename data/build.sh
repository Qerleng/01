...
curl -Lo geoip.db "https://github.com/Qerleng/02/releases/latest/download/GeoIP.db"
curl -Lo geosite.db "https://github.com/Qerleng/02/releases/latest/download/GeoSite.db"
curl -Lo geoip.dat "https://github.com/Qerleng/02/releases/latest/download/GeoIP.dat"
curl -Lo geosite.dat "https://github.com/Qerleng/02/releases/latest/download/GeoSite.dat"
